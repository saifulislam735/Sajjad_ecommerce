   ...
   <div class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.php"><span style="color:orange" class="glyphicon glyphicon-home">&nbsp;MobileMart BD</span></a>
        </div>
        <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="nav navbar-nav navbar-right">
                ...
                if (isset($_SESSION['email'])) {
                    ?>
                    <li><a href="products.php"><span class="glyphicon glyphicon-th"></span> Product Menu</a></li>
